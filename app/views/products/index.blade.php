...
<h1 class="text-center uptest blck2">{{$category->name}} UNLOCKING</h1>
@stop
...
@foreach($product as $product)
 ...
 <a href="#" class="thumbnail">
    ...
    <div class="mg">
   	<p class="text-center"><a class="blck" href="{{URL::to('product/' .$product->id)}}"><span>{{$product->product_name}}</span></a></p>
   </div>
   <p></p> 
 </div>
...
<p>Any questions? Then <a href=""> contact us right away</a> or call 0244072639 or 0560094454</p>
@stop
