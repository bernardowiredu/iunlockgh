...
<h4 class="blue"><b>Terms and conditions for unlocking {{$phones->product_name}}</b></h4>
...
<p class="blue"><i class="glyphicon glyphicon-alert"></i> <b>If you have not registered on the system please enter your mail or mobile number before continuing with order</b></p>
</div>
</div>
