...
<div class="form-group">
    ...
    <label class="blck" for="exampleInputEmail1">Username</label>
    <input type="text" class="form-control"  name="username" id="username" placeholder="Enter username" required>
  </div>
  <div class="form-group">

     
    <label  class="blck" for="exampleInputPassword1">Email address</label>
   ...
   <div class="form-group">
    <label  class="blck" for="exampleInputPassword1">Password</label>
   ...
   <div class="form-group">
    <label class="blck" for="exampleInputPassword1">Confirm Password</label>
   ...
   <div class="form-group">
    <label class="blck" for="exampleInputPassword1">Phone number</label>
  ...
  <div class="checkbox">
    <label>
      <input type="checkbox" required><span class="blck">I have agreed to the</span>  <a href="terms and conditions">terms and conditions </a>
    </label>
  </div>
