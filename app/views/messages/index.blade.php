...
<img src="../public/img/folder_conflicted.png" class="img-responsive"> Messages
 ...
 <div class="tabbable"> 
    ...
    <form>
      <div class="form-group">
        <label for="exampleInputEmail1" class="blck2">Email address</label>
        <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1" class="blck2">Password</label>
        <input type="password" class="form-control" class="blck2" id="exampleInputPassword1" placeholder="Password">
      </div>
      <div class="form-group">
        <label for="exampleInputFile" class="blck2">Send message</label>
