...
<h1 class="text-center blck2">UNLOCKING INSTRUCTION</h1>
...
<h4 class="well mf"><b class="blue">PHONE UNLOCKING GUIDE</b></h4>
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default">
    ...
    <h4 class="yellow"><b>Model : BlackBerry OS10 (Z10, Q10, Z5, etc..)</b></h4>
    ...
    <h4 class="yellow"><b>Model : Blackberry 9530 Storm</b></h4>
    ...
    <h4 class="yellow"><b>Model : BlackBerry Bold 9000 & Torch</b></h4>
    ...
    <h4 class="yellow"><b>Model : Curve, 8300, 8310, 8320, 8800, 8820</b></h4>
    ...
    <h4 class="yellow"><b>Model : BlackBery Storm (9500)</b></h4>
    <ul class="nav">
    ...
    <h4 class="yellow"><b>Model : BlackBerry 8700</b></h4>
    ...
    <h4 class="yellow"><b>Model : BlackBerry 8800</b></h4>
    ...
    <h4 class="yellow"><b>Model : BlackBerry 8100 Pearl</b></h4>
    <ul class="nav"> 
    ...
    <h4 class="yellow"><b>Model : BlackBerry 8100 (Vodafone Australia)</b></h4>
    ...
    <p class="yellow"><b>Question: My phone asks to enter a PIN number</b></p>
    ...
    <h4 class="yellow"><b>Model : All BlackBerry</b></h4>
    <ul class="nav">
