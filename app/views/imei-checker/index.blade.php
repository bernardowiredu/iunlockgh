...
<h1 class="text-center blck2">IMEI CHECK SERVICES</h1>
@stop
...
<div class="panel panel-default">
  ...
  <div class="panel-body mf">
	...
	<select class="form-control" name="network_name" id="network_name" >
		...
		<option value="3" data-price="free" data-delivery="Instant">FREE ICLOUD STATUS CHECK</option>
...
<label class="blck2">Telephone</label>
	...
	<p><a href="{{URL::to('login')}}"><button class="btn btn-danger"><i class="glyphicon glyphicon-user"></i> Please login to contiune</button></a></p>
