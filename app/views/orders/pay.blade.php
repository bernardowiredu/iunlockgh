  ...
  <body>
    ...
    <div class="panel panel-inverse">
      ...
      <div class="panel-body blck mf">
        ...
        <div class="well well-sm  around col-md-6 notice-info">
        <h4 class="blck">ORDER DETAILS</h4>
          <b class="blck">Your {{$order->product_name}} unlocking service <font color="green">(working)</font></b>
          <p class="text-muted">Unlocking time: {{$order->delivery}}</p>
          <h4 class="blck"><b>Total: GH₵ {{$order->price}}</b></h4>
      ...
      <span class="red"><b>Enter a valid mobile number to recieve order notifications</b></span>
      </p>
